...
<form method='POST' action="message.php?id=<?php echo $id; ?>">
	...
	<button class="logovote" name="jaime<?php echo $i ?>"><img class="logovote-2" height="40"src="upload/aime.jpg"></button><br />
	<label><?php echo $resultataime2[0][0] ?></label>
	<button class="logovote" name="jaimepas<?php echo $i ?>"><img class="logovote-2" height="40" src="upload/aimepas.jpg"></button><br />
</form>